...
connected_user = label.Label(terminalio.FONT, text="connected to {}".format(reciever_username), color=0xFFFFFF, x=0, y=59)
...
while True:
    ...
    if not btn1.value:
        print("button pressed current status : " , autopilot_enabled)
